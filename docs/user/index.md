...
VERALTET: Der «Smoketest» um im Betrieb die Verfügbarkeit des ccc-services zu testen, ist [hier](probetool.md) beschrieben.

## VERALTET: System Anforderungen
...
VERALTET: Der ccc-service unterstützt zusätzlich die folgenden Umgebungsvariablen:
