...
This file defines coding standards, constraints, workflow rules and output expectations that apply to **all** AI coding agents in this repo. For tool-agnostic project facts (build commands, test layout, architecture, Docker, runtime, security feature flags) see [`AGENTS.md`](AGENTS.md).
